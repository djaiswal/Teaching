...
**Question 2. Draw a curve showing biomass of stem, leaves, and below-ground components on the Y axis (tons ha$^{-1}$) and time ($t$) on the x axis from $t_{0}$ to $t_{harvest}$ for miscanthus and sugarcane.Not that no biomass can be less than zero. Once biomass of any component reaches zero, it stay zero as long as regrowth (next year) does not start [max score = 6]**
