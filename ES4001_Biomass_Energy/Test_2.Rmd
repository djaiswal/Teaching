...
**Question 2. Draw a curve showing biomass of stem, leaves, and below-ground components on the Y axis (tons ha$^{-1}$) and time ($t$) on the x axis from $t_{0}$ to $t_{harvest}$ for miscanthus and sugarcane. [max score = 6]**


**Question 3. Calculate the amount of biomass that can be transported from 1ha of miscanthus and sugarcane fields to a nearby bio refinery for producing bio ethanol assuming that harvesting occurs on t= $t_{harvest}$ for both sugarcane and miscanthus . [max score =4]**
